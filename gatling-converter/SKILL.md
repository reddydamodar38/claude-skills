...
- Set `GATLING_CONFIG_PASSWORD` for generated Gatling configuration and scenario data.
- Set the database password variable required by the selected `DbEnv`; the SQLPlus skill documents the supported names.
